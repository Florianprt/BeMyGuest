        ...
        $('.wizard').each(function () {
            ...
            $(this).stepFormWizard({  
                ...
                onNext: function(i, wizard) {
                    if(($this.hasClass('wizard-validation'))&&($this.hasClass('insertdish'))){
                        if(i==2){
                            $( "#showdishimage" ).append($('#dishimage').html());
                            $( "#showname" ).text($('#namedish').val());
                            $( "#showtheprice" ).text($( "input[name='price']").val());
                            var address = $( "input[name='adress']").val()+' '+$( "input[name='city']").val()+' '+$( "input[name='zipcode']").val();
                            $( "#showadress" ).text(address);
                            $( "#showingredients" ).text($( "input[name='ingredients']").val());
                            var quantity = 'For '+$( "#quantity").val()+' people';
                            $( "#shownumber" ).text(quantity);
                            $( "#showdescription" ).text($( "textarea[name='description']").val());
                    ...
                    else if ($this.hasClass('wizard-validation')){
                        return $('form', wizard).parsley().validate('block' + i);
                    }    
                },
                onFinish: function(i) {
