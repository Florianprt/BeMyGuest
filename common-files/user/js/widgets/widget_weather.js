...
function widgetWeather(){
    ...
    var weatherWidget = '<div class="panel-header" style="background: #319DB5"><h3><i class="icon-30"></i> <strong>Weather</strong></h3></div><div class="weather panel-content" class="widget-container widget-weather boxed"><div class="weather-highlighted">';
    ...
    weatherWidget += '<div class="weather-search-form"><input type="text" name="search2" value="" id="city-form" class="weather-search-field" placeholder="Find !"><input type="submit" value="" class="btn weather-search-submit" name="search-send2"></div></div><ul class="weather-forecast clearfix">';
