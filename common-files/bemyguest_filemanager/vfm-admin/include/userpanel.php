<?php
/**
 * VFM - veno file manager: include/userpanel.php
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <form role="form" method="post" id="usrForm">
...
if ($gateKeeper->isUserLoggedIn()) {
    ...
    if ($setUp->getConfig("show_usermenu") == true ) { 
        ...
        if ($gateKeeper->isSuperAdmin()) {
            echo " <a class=\"pull-right btn btn-default btn-sm\" href=\"vfm-admin/\"><i class=\"fa fa-cogs\"></i> "
...
if ($setUp->showLangMenu()) { ?>
    ...
    <?php
    print ($encodeExplorer->printLangMenu('vfm-admin/'))."</div>";
} ?>
