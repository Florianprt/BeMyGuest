...
<?php if (isset($_GET['languagemanager'])) { ?>
    ...
    if (($_GET['languagemanager'] == 'editlang' 
        ...
        <?php
        print "<button type=\"submit\" class=\"btn btn-info pull-right btn-lg \">
            <i class=\"fa fa-refresh\"></i> "
            .$encodeExplorer->getString("save_settings")."</button>";
        ?>
    ...
    <?php
        ...
        class="unmezzo pull-left">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="editlang">
    <?php
        ...
        class="unmezzo pull-right">
            <div class="intero">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="newlang">
                </div>
                ...
                <p><?php print $encodeExplorer->getString("2_letters_iso_code"); ?>
                    <a target="_blank" href="http://www.loc.gov/standards/iso639-2/php/code_list.php">
    ...
    */
    ?>        
        <div class="intero adminblock well">
                <h2 class="pull-left"><i class="fa fa-users"></i> 
                    <?php print $encodeExplorer->getString("users"); ?></h2>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group pull-left intero">
                        <h3><i class="fa fa-plus"></i> 
                            <?php print $encodeExplorer->getString("add_user"); ?></h3>
    ...
    enctype="multipart/form-data">
        <div class="unmezzo pull-right">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="form-group pull-left intero">
                        <h3><i class="vfmi vfmi-king"></i></a> Master Admin</h3>
    ...
    foreach ($utenti as $key => $user) {
        ...
        <div class="unmezzo <?php echo $ide; ?>">
            ...
            <div class="pull-left intero usrblock">
                        <button class="btn btn-block btn-lg btn-default usrindex" data-toggle="modal" data-target="#modaluser">
                        ...
                        <input type="hidden" value="<?php echo $user['quota']; ?>" class="s-quota">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title"><i class="fa fa-edit"></i> <span class="modalusername"></span</h3>
                </div>
    ...
    */
    ...
    <div class="wrapstat">
    <table class="table statistics table-hover table-condensed" id="sortanalytics">
      <thead>
          <tr>
    ...
    foreach ($polarplay as $key => $value) {
        $color = rand(0, 250).",".rand(0, 250).",".rand(0, 250);
        echo "{ value: ".$value.",";
        echo "label: '".$key."',";
        echo "title: '".$key."',";
        echo "color:\"rgba(".$color.",0.8)\",";
        echo "highlight:\"rgba(".$color.",0.6)\"},";
    }
         ?>
            ];
    ...
    */
    ...
    ?>
        ...
        class="clear intero" enctype="multipart/form-data">
            <div class="intero adminblock">
            <div class="intero well">



        <h2 class="pull-left"><i class="fa fa-cogs"></i> 
            <?php print $encodeExplorer->getString("general_settings"); ?></h2>
...
<?php print $encodeExplorer->getString("inline_thumbs"); ?>
    ...
    if ($setUp->getConfig('thumbnails')) {
        echo "checked";
    } ?>><i class="fa fa-picture-o fa-border fa-inverse" style="background:#333;"></i>
    ...
    <?php print $encodeExplorer->getString("share_files"); ?>
            ...
            <div class="form-group toggled intero">
    ...
    */ 
    ...
    <div class="intero well">
        ...
        <form role="form" method="post" 
        action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" 
        class="clear unmezzo pull-left" enctype="multipart/form-data">
            <div class="form-group">
            <div class="input-group">
            ...
            <button class="upload_sumbit btn btn-info pull-left" type="submit">
                <?php print $encodeExplorer->getString("upload"); ?>
            </button>
        </form>

        <div class="unmezzo pull-right placeheader">
            <img class="img-responsive" src="images/<?php print $setUp->getConfig('logo'); ?>">
        </div>
    </div>
