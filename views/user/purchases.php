      ...
      <!-- Fin haut de la page header en blanc -->
        ...
        <div class="page-content page-thin">
            ...
            <div class="col-md-12 col-sm-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3>Oh Hello <?php echo $data['personnal_information']['first_name']?>,<br>Here there are all your previous order !</h3>
                </div>
              </div>
          ...
          <?php if ($data['nbr']['buy']!=0) { ?>
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3><i class="fa fa-table"></i>Purchases</h3>
                </div>
          ...
          <?php } else { ?>
              <div class="panel">
                <div class="panel-header panel-controls t-center" style="padding:80px">
                  <h3>You never buy a dish, you want to try one ?</h3>
                  <a href="home" class=" btn btn-purple  btn-transparent m-t-40">Click here to find a delicious dish</a>
                </div>
              </div>
          <?php }?>
          </div>
