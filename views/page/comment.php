<?php include('layout/header.php'); ?>
  <section class="m-t-80" <?php if ((isset($data['bueno']['ok']))&&($data['bueno']['ok']=="ok")) {echo 'style="display:none"';} ?>>
    ...
    <div <?php if (!isset($_COOKIE['log'])) {echo 'style="display:none"';} ?>class="container">
      <div class="row t-center">
        <h2 class="section-title t-center">Hi , can you recommend <?php echo $data['user_get']['nom'].' '.$data['user_get']['prenom']; ?> !</h2>
      </div>
      <div class="row m-t-40 t-center">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
          <p>Please recommend <?php echo $data['user_get']['nom'].' '.$data['user_get']['prenom']; ?> for his services !</p>
          <form id="profil_form" method="post" action="<?php echo BASE.'comment/'.$_GET['id']; ?>" autocomplete="off" enctype="multipart/form-data">
