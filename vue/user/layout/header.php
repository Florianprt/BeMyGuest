        ...
        <div class="topbar">
          ...
          <div class="header-right">
            <ul class="header-menu nav navbar-nav">
              <li class=""><a class="btheader" href="#"><div class="border-yellow  p-l-20 p-r-20">Yo want to cook?</div></a></li>
              <li class=""><a href="#">Help</a></li>
              <li class=""><a href="../">Go back to site</a></li>
              <li class="dropdown" id="user-header">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="#"><i class="icon-settings"></i><span>My Message Settings</span></a>
                  </li>
                  <li>
